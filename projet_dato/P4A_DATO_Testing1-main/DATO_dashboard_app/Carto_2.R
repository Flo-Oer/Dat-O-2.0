...
shpaffich <- "./www/Donnees_Dato/wMain_202205_Nice_secteurs/wMain_202205_Nice_secteurs.shp"
...
donnees_sondes_file <- "./www/Dato donnees clean/MasterKaptaV2.xlsx"
donnees_sondes <- read_excel(donnees_sondes_file, range = cell_cols("C:P"))


# Read the Excel file with point coordinates
position_sondes_file <- "./www/Dato donnees clean/position-sondes-global.xlsx"
position_sondes <- read_excel(position_sondes_file)

# Read the Excel file with point data
psv_data_file <- "./www/Dato donnees clean/donnees_PSV.xlsx"
psv_data <- read_excel(psv_data_file)


# Read the shapefile with position_PSV and Transform the spatial coordinates to EPSG 4326 to extract X and Y coordinates
position_PSV <- st_read("./www/Donnees_Dato/Loc_PSV_V4/Loc_PSV_V4.shp")
...
get_icon_url <- function(concentration) {
  ifelse(is.na(concentration),
         "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/marker-icon-2x-black.png",
         ifelse(concentration < 0.1,
                "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/marker-icon-2x-red.png",
                ifelse(concentration < 0.15,
                       "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/marker-icon-2x-gold.png",
                       "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/marker-icon-2x-green.png")))
}
...
get_icon_url_sondes <- function(concentration) {
  ifelse(is.na(concentration),
         "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/icon_sondes_gris.png",
         ifelse(concentration < 0.1,
                "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/icon_sondes_rouge_fonce.png",
                ifelse(concentration < 0.15,
                       "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/icon_sondes_jaune.png.png",
                       "/Users/delaygues/P4A_DATO/DATO_dashboard_app/www/icon/icon_sondes_vert.png.png")))
}
