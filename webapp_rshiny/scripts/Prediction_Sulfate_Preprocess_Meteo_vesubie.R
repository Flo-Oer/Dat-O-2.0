...
library("readxl")
library(lubridate)
st_mart2014_2017 = read_excel('../data/prediction_sulfate_input/obs_ST_MARTIN_VESUBIE_SAPC_2014_2017.xls')
st_mart2017_2020 = read_excel('../data/prediction_sulfate_input/obs_ST_MARTIN_VESUBIE_SAPC_mod.xls')
st_mart2021_2023 = read_excel('../data/prediction_sulfate_input/obs_ST_MARTIN_VESUBIE_OBS_2021-2023.xls')
st_mart2023_2025 = read_excel('../data/prediction_sulfate_input/obs_ST_MARTIN_VESUBIE_OBS_2023-2025.xls')
...
write.csv(meteo_st_martin, "../data/prediction_sulfate_output/meteo_st_martin.csv", row.names = FALSE)
getwd() 
